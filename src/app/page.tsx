...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* 🎬 HERO SECTION */}
      <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black z-30 pt-20">
        ...
        {/* HERO CONTENT LAYER */}
        <div className="relative z-10 max-w-5xl mx-auto w-full px-6 flex flex-col items-center justify-center text-center py-20">
          <motion.div
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center space-y-2 select-none pointer-events-none opacity-60">
          ...
          <div className="w-5 h-8 border-2 border-white/30 rounded-full flex justify-center p-1">
            <motion.div
              ...
              className="w-1 h-2 bg-brand-accent rounded-full"
            />
          </div>
        </div>
      </section>
